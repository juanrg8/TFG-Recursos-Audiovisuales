...
public class UserAlbumServiceImpl implements UserAlbumService {
	...
	public String addUserAlbum(UserAlbum userAlbum) {
		...
		Optional<UserAlbum> existingAlbum = userAlbumRepository
				.findByUsuarioIdAndAlbumId(userAlbum.getUsuario().getId(), userAlbum.getAlbum().getId());
	...
	@Override
	public String moveUserAlbumToStatus(Integer usuarioId, Integer albumId, AlbumStatus status) {
