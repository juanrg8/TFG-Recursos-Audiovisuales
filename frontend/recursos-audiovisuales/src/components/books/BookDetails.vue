    ...
    <div>
      ...
      <div class="card mb-3 customBookCard">
        ...
        <div class="card-body">
          ...
          <h5 class="card-title" v-if="userBookUser.status == 'PENDING'">
            Pendiente
          </h5>
          <h5 class="card-title" v-if="userBookUser.status == 'READING'">
            Leyendo
          </h5>
          <h5 class="card-title" v-if="userBookUser.status == 'READED'">
            Leído
          </h5>
          <h5 class="card-title" v-if="userBookUser.dateStarted != null">
            Inicio de la lectura: {{ userBookUser.dateStarted }}
          </h5>
          <h5 class="card-title" v-if="userBookUser.dateRead != null">
            Fin de la lectura: {{ userBookUser.dateRead }}
          </h5>
